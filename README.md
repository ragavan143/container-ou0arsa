...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ou0arsa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ou0arsa.containers.anotherwebservice.com/
...
```
git clone git@github.com:ragavan143/container-ou0arsa.git
cd container-ou0arsa
```
...
```
docker attach container-ou0arsa
```
